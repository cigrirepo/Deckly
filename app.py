...
# -- 1) Bullets → Structured Outline via LLM
@st.cache_data
...
{bullets}"""
    try:
        ...
        # Fallback: single section with raw bullets
...
# -- 3) Logo Style Description (Vision)
@st.cache_data
    ...
    for sec in outline:
        ...
        if logo_bytes:
            try:
                ...
                pic = slide.shapes.add_picture(stream,
                    prs.slide_width - Inches(1.2), prs.slide_height - Inches(1.2),
